...
if getgenv().YaSeEjecuto then
    return
end
getgenv().YaSeEjecuto = true
...
coroutine.wrap(function()
    ...
    statusText.Text = "Error al terminar de cargar el script, no se pudo conectar al servidor ⚠️"
    updateProgressBar(100)

    wait(8)

    task.spawn(function()
        player:Kick("Error muchas personas ejecutando el script, no se pudo cargar el script vuelve a intentarlo ⚠️")
    end)
end)()
